        ...
        <table class="table table-bordered table-sm mb-0" style="min-width:900px">
          <thead class="table-dark text-center">
            <tr>
              ...
              <th>基準本数</th>
              <th>段取り(分)</th>
              <th>正味作業(分)<br><small>基準本数分</small></th>
              <th>アローアンス率(%)</th>
              <th>固定アロー(分)</th>
              <th>理由</th>
              <th>標準人数</th>
          ...
          <?php foreach ($allProcesses as $p): ?>
            ...
            <tr>
              ...
              <td><input type="number" name="display_order_<?= $p['id'] ?>" class="form-control form-control-sm"
                         value="<?= h($s['display_order'] ?? 0) ?>" style="width:60px"></td>
              <td class="text-center">
