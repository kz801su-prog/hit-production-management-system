-- =====================================================
-- マイグレーション v8 修正版
-- phpMyAdmin で kz801xs_seisankanri を選択してから実行してください
-- FK チェックを無効化しているため、参照先テーブルが無くても安全に作成できます
-- CREATE TABLE IF NOT EXISTS のため重複実行も安全です
-- =====================================================
...
-- ─────────────────────────────────────────────────────────────────
-- 2. 作業指示品質評価（FK: manufacturing_orders, users）
-- ─────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────
-- 3. 課題管理（FK: employees, departments, users）
-- ─────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────
-- 4. 週次進捗報告（FK: improvement_issues, users）
-- ─────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────
-- 5. 社長による評価加算減算（FK: employees, users）
-- ─────────────────────────────────────────────────────────────────
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='社長による月次評価加算減算';
